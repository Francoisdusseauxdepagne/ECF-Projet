let articleNbre = 0;
// Fonction pour récupérer les articles du panier depuis le serveur
...
function displayPanier(articles) {
    ...
    articles.forEach(article => {
        ...
        articleElement.classList.add("produitInPanier", "card", "mb-3", "col-md-12", "col-lg-4", "col-sm-12");
...
function displayArticle(articles) {
    const articleElement = document.querySelector("#vueJean");
